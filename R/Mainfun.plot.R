...
#' @import patchwork
#'
#' @return For \code{ecosystem = 'single'}, return a figure for multi-functionality with uncorrelated/correlated functions. For \code{ecosystem = 'multiple'}, return a figure when input contains only uncorrelated or correlated MF decomposition or
...
#'
#' @export
ggmf = function(output, ecosystem, scale = 'fixed', fit.lm = TRUE){
